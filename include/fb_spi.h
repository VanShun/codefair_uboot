...
/**
 * fastboot_spi_get_part_info() - Lookup NAND partion by name
 *
...
/**
 * fastboot_spi_flash_write() - Write image to NAND for fastboot
 *
...
/**
 * fastboot_spi_flash_erase() - Erase NAND for fastboot
 *
