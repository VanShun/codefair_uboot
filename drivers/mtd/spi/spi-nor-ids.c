...
const struct flash_info spi_nor_ids[] = {
	...
	/* EON -- en25xxx */
	{ INFO("en25qh16",   0x1c7015, 0, 64 * 1024,   32, 0) },
	{ INFO("en25q32b",   0x1c3016, 0, 64 * 1024,   64, 0) },
	{ INFO("en25qh32",   0x1c7016, 0, 64 * 1024,   64, 0) },
	...
	{
		INFO("gd25q127", 0xc84018, 0, 64 * 1024, 256,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ)
	},
	{
	...
	{
		INFO("gd25q512", 0xc8471a, 0, 64 * 1024, 1024,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_4B_OPCODES)
	},
	{
	...
	{ INFO("w25q01jv", 0xef4021, 0, 64 * 1024, 2048, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_4B_OPCODES) },
#endif
	...
	/* HuaHong */
	{
		INFO("bh25q64bs", 0x684017, 0, 64 * 1024, 128,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ)
	},
	{ },
};
